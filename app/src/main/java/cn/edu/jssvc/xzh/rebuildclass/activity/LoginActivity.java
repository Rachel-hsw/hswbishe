...
public class LoginActivity extends BaseActivity {
    ...
    // 登录请求服务器地址
    private String URL =webAddress+ "login";
    // 图片所在位置的网络请求地址
                ...
                public void denied(List<String> deniedList) {
                    ...
                    for (String denied : deniedList) {
                        if (denied.equals("android.permission.WRITE_EXTERNAL_STORAGE")) {
                            ...
                            Log.i(getClass().getName(),"没有文件读写权限！");
                        } else if (denied.equals("android.permission.READ_EXTERNAL_STORAGE")){

                            Log.i(getClass().getName(),"没有文件读写权限,请检查是否打开！");
                        } else if (denied.equals("android.permission.MOUNT_UNMOUNT_FILESYSTEMS")){

                            Log.i(getClass().getName(),"没有挂载权限！");
                        }
                    }
                }
            });
