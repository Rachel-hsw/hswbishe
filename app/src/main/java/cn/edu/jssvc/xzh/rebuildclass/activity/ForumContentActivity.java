...
public class ForumContentActivity extends BaseActivity {
    ...
    // 读取评论列表的服务器请求地址
    private String URL = webAddress+ "readDiscussList";
    // 读取评论列表的服务器请求地址
    private String URL2 = webAddress+ "insertDiscussList";
    // 读取用户头像所在位置的网络请求地址
        ...
        if (fImageFromForum.equals("0")) {
            ...
            picture.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    String data = fImageFromForum;
                    Intent intent = new Intent(ForumContentActivity.this, ZoomActivity.class);
