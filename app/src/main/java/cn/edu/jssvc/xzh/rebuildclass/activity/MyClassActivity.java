...
public class MyClassActivity extends BaseActivity {
    ...
    // 读取我的收藏
    private static final String URL = webAddress+ "readMyClass";
    // 从我的收藏中取消
    private static final String DELETE_URL = webAddress+ "deleteMyClass";
    // 图片地址
    private static final String IMG_URL = webAddress+ "";
